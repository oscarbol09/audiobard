...
AudioBard includes an automated, hermetic benchmark suite to score the dialogue attribution accuracy of various LLM backends against hand-labeled ground truth literature.

---

## 🎯 The Gold Standard (`eval/gold_standard/`)

The gold standard dataset is located in `eval/gold_standard/` and contains hand-verified dialog attribution for classic literature (e.g. *Pride and Prejudice*, Chapter 3).
